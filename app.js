...
var Vector2D_1 = require("Vector2D");
var sweep = Data_Array.filter(function ($115) {
    return !(function (v) {
        return v.hit;
    })($115);
});
...
var renderS = function (v) {
    ...
    var flash = (function () {
        ...
        throw new Error("Failed pattern match at Main line 158, column 13 - line 162, column 5: " + [ $68.constructor.name ]);
    })();
...
var bounce = function (v) {
    var newVelocity = (function () {
        var $76 = v.position.y < 30.0 || v.position.y > 570.0;
        if ($76) {
            return {
                x: v.velocity.x, 
                y: -v.velocity.y
        ...
        throw new Error("Failed pattern match at Main line 86, column 21 - line 89, column 3: " + [ $76.constructor.name ]);
    })();
    var $77 = {};
    for (var $78 in v) {
        if (v.hasOwnProperty($78)) {
            $77[$78] = v[$78];
        };
    };
    $77.velocity = newVelocity;
    return $77;
};
var step = function (v) {
    return function (v1) {
        ...
        var newEnemyCooldown = (function () {
            ...
            throw new Error("Failed pattern match at Main line 112, column 26 - line 113, column 7: " + [ $86.constructor.name ]);
        })();
        var newEnemies = Prelude.map(Prelude.functorArray)(function ($116) {
            return move(bounce($116));
        })(sweep(Prelude.append(Prelude.semigroupArray)(v1.enemies)((function () {
            var $87 = v1.enemyCooldown === 0;
            if ($87) {
            ...
            throw new Error("Failed pattern match at Main line 109, column 20 - line 112, column 7: " + [ $87.constructor.name ]);
        })())));
        ...
        var newCannonCooldown = (function () {
            ...
            if (!doesNewProjectileSpawn) {
                ...
                throw new Error("Failed pattern match at Main line 115, column 32 - line 118, column 7: " + [ $89.constructor.name ]);
            };
            throw new Error("Failed pattern match at Main line 113, column 27 - line 118, column 7: " + [ doesNewProjectileSpawn.constructor.name ]);
        })();
        var cannonDirection = $$Math.atan2(-($$Math.max(cannonPosition.x)(v.position.x) - cannonPosition.x))(v.position.y - cannonPosition.y);
        var newProjectiles = (function ($117) {
            return Data_Array.filter(cull)(Prelude.map(Prelude.functorArray)(move)($117));
            ...
            throw new Error("Failed pattern match at Main line 106, column 24 - line 109, column 7: " + [ doesNewProjectileSpawn.constructor.name ]);
        })())));
        return mark({
...
var main = function __do() {
    ...
    if (v instanceof Data_Maybe.Just) {
        ...
        return Signal.runSignal(Prelude["<#>"](Signal.functorSignal)(state)(function ($118) {
            return Graphics_Drawing.render(v1)(renderS($118));
        }))();
    };
    throw new Error("Failed pattern match at Main line 188, column 8 - line 210, column 47: " + [ v.constructor.name ]);
};
module.exports = {
    main: main, 
